...
public class DreamsMapper {
    public static String GET_ALL_USER_DREAMS = "select id_dream as dreamId, dream_name as dreamName, dream_date as dreamDate, dream_text as dreamText, dream_duration as dreamDuration\nfrom dreams\nwhere id_user in (select id_user from users where user_name = ?) order by id_dream DESC";
    ...
    public static String DELETE_DREAM = "delete from dreams where id_dream = ?";
}
